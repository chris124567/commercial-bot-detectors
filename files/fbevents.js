/*
Retrieved from https://connect.facebook.net/en_US/fbevents.js.
NOTE: There is basically no fingerprinting here.  What's interesting is the bot detection.
*/
        ...
        f.ensureModuleRegistered("SignalsFBEventsConfigStore", function() {
            return function(g, i, j, k) {
                ...
                (function() {
                    ...
                    var m = f.getFbeventsModules("signalsFBEventsCoerceAutomaticMatchingConfig"),
                        n = f.getFbeventsModules("signalsFBEventsCoerceInferedEventsConfig"),
        ...
        f.ensureModuleRegistered("SignalsFBEvents", function() {
            return function(h, i, k, l) {
                ...
                (function() {
                    "use strict";
                    var a = h.fbq;
                    a.execStart = h.performance && typeof h.performance.now === "function" ? h.performance.now() : null;
                    ...
                    function ia(d) {
                        ...
                        switch (d) {
                            ...
                            case "firstPartyCookies":
                                ...
                                typeof p === "string" ? V.callMethod([r, p, "FirstPartyCookies"]) : p === void 0 ? V.disableFirstPartyCookies = !0 : L({
                                    invalidParamName: "pixel_id",
                                    invalidParamValue: p,
                                    method: "set",
                                    params: h,
                            ...
                            case "trackSingleOnly":
                                ...
                                O.call(T, F) ? T[F].trackSingleOnly = E : L({
                                    metadataValue: d,
                                    pixelID: F,
                                ...
                                break;
                            default:
                                var H = V.pluginConfig.getWithGlobalFallback(null, "dataProcessingOptions"),
                    ...
                    function Y(a, b, c) {
                        ...
                        if (O.call(T, d)) {
                            b != null && F(T[d].userData) ? (T[d].userData = e ? b || {} : {}, W.loadPlugin("identity")) : L({
                                pixelID: d,
                    ...
                    function oa(b, c) {
                        ...
                        e.append("coo", c);
                        c = V.pluginConfig.getWithGlobalFallback(b ? b.id : null, "dataProcessingOptions");
                        if (c != null) {
